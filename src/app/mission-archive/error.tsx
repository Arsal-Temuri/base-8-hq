...
export default function MissionArchiveError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error("[BASE8HQ] Mission Archive error:", error);
  }, [error]);
    ...
    <div className="min-h-screen flex items-center justify-center bg-background px-4 relative overflow-hidden">
      ...
      >
        ...
        <p className="text-muted-foreground text-sm leading-relaxed mb-6">
          The mission archive could not be retrieved. Attempt to restore access
          or return to headquarters.
        </p>
        {error?.digest && (
