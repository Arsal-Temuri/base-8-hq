    ...
    <PageWrapper>
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0">
          <Image src={heroBg} alt="Hero Background" fill sizes="100vw" className="object-cover opacity-40" priority quality={75} />
        ...
        <div className="relative container mx-auto px-4 text-center pt-20">
          ...
          >
            <Link href="/deploy-mission" className="btn-glow-filled rounded-sm">Start a Project</Link>
            <Link href="/contact" className="btn-glow rounded-sm">Get a Strategy Call</Link>
          </motion.div>
        </div>
      </section>
