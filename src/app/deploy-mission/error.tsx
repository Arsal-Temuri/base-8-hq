...
export default function DeployMissionError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error("[BASE8HQ] Deploy Mission error:", error);
  }, [error]);
    ...
    <div className="min-h-screen flex items-center justify-center bg-background px-4 relative overflow-hidden">
      ...
      >
        ...
        <p className="text-muted-foreground text-sm leading-relaxed mb-6">
          The mission brief form encountered a critical error. Retry the launch
          sequence or contact the command center directly.
        </p>
        {error?.digest && (
