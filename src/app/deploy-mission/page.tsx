...
const DeployMissionPage = () => {
  ...
  const selectedCountry = useWatch({ control: form.control, name: "country" }) as keyof typeof COUNTRY_BUDGET_MAP;
  const selectedBudgetRules = COUNTRY_BUDGET_MAP[selectedCountry] || COUNTRY_BUDGET_MAP["Pakistan"];
