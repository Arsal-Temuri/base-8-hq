...
export default function OperationalUnitsError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error("[BASE8HQ] Operational Units error:", error);
  }, [error]);
    ...
    <div className="min-h-screen flex items-center justify-center bg-background px-4 relative overflow-hidden">
      ...
      >
        ...
        <p className="text-muted-foreground text-sm leading-relaxed mb-6">
          Operational Units failed to initialise. Attempt to re-establish the
          connection or return to headquarters.
        </p>
        {error?.digest && (
